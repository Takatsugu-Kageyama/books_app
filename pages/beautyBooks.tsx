  ...
  while (newBooksData == undefined && popularBooksData == undefined && evaluationBooksData == undefined) {
    if (newBooksData == undefined) {
      ...
      const fetchNewComic = await fetch(
        "https://app.rakuten.co.jp/services/api/BooksTotal/Search/20170404?applicationId=1030475744401461181&booksGenreId=001010&sort=-releaseDate&hits=7"
      );
    ...
    if (popularBooksData == undefined) {
      ...
      const fetchPopularComic = await fetch(
        "https://app.rakuten.co.jp/services/api/BooksTotal/Search/20170404?applicationId=1030475744401461181&booksGenreId=001010&sort=sales&hits=7"
      );
    ...
    if (evaluationBooksData == undefined) {
      ...
      const fetchEvaluationComic = await fetch(
        "https://app.rakuten.co.jp/services/api/BooksTotal/Search/20170404?applicationId=1030475744401461181&booksGenreId=001010&sort=reviewAverage&hits=7"
      );
